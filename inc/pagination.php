 ...
 *
 * Stolen 2019-04-02 from [https://github.com/SimonPadbury/b4st/blob/master/functions/index-pagination.php]
 */
...
if ( ! function_exists( 'b4st_pagination' ) ) {
	function b4st_pagination() {
		...
		$paginate_links = paginate_links( array(
			...
			'mid_size' => 5,
			'prev_next' => True,
			'prev_text' => __('<i class="fas fa-angle-left"></i> Newer', 'mytheme'),
			'next_text' => __('Older <i class="fas fa-angle-right"></i>', 'mytheme'),
			'type' => 'list'
		) );
